...
public class MHWirthGearBoxAndSwivelMonitoringUseCase {
    ...
    public MHWirthGearBoxAndSwivelMonitoringUseCase(String url) {
        try {
            ...
            if(!RestRequest.isSensorRegistered(sensorArray[0]))
            ...
            if(!RestRequest.isSensorRegistered(sensorArray[1]))
            ...
            if(!RestRequest.isSensorRegistered(sensorArray[2]))
            ...
            if(!RestRequest.isSensorRegistered(sensorArray[3]))
            ...
            if(!RestRequest.isSensorRegistered(sensorArray[4]))
            ...
            if(!RestRequest.isSensorRegistered(sensorArray[5]))
            ...
            if(!RestRequest.isSensorRegistered(sensorArray[6]))
            ...
            if(!RestRequest.isSensorRegistered(sensorArray[7]))
