...
public class SimpleEventListenerKafkaTopic implements Runnable {
    ...
    public SimpleEventListenerKafkaTopic(BlockingQueue<EventDocument> queue, String zooKeeper, String groupId, String topic) {
        this.queue = queue;
