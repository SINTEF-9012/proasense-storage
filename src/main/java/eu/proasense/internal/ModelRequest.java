...
public class ModelRequest implements org.apache.thrift.TBase<ModelRequest, ModelRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ModelRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ModelRequest");
  ...
  static {
    schemes.put(StandardScheme.class, new ModelRequestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ModelRequestTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ModelRequest.class, metaDataMap);
  }
   ...
   */
  public ModelRequest(ModelRequest other) {
  ...
  public ModelRequest setModelType(String modelType) {
    this.modelType = modelType;
    return this;
  }
  ...
  public ModelRequest setComponentId(String componentId) {
    this.componentId = componentId;
    return this;
  }
  ...
  public ModelRequest setBlob(String blob) {
    this.blob = blob;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ModelRequest)
      return this.equals((ModelRequest)that);
    return false;
  }

  public boolean equals(ModelRequest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ModelRequest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ModelRequest(");
    boolean first = true;
  ...
  private static class ModelRequestStandardSchemeFactory implements SchemeFactory {
    public ModelRequestStandardScheme getScheme() {
      return new ModelRequestStandardScheme();
    }
  }

  private static class ModelRequestStandardScheme extends StandardScheme<ModelRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ModelRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ModelRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ModelRequestTupleSchemeFactory implements SchemeFactory {
    public ModelRequestTupleScheme getScheme() {
      return new ModelRequestTupleScheme();
    }
  }

  private static class ModelRequestTupleScheme extends TupleScheme<ModelRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ModelRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ModelRequest struct) throws org.apache.thrift.TException {
