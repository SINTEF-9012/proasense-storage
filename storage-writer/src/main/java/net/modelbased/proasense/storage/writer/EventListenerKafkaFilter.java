...
public class EventListenerKafkaFilter<T> implements Runnable {
    ...
    public EventListenerKafkaFilter(Class<T> eventType, BlockingQueue<EventDocument> queue, String zooKeeper, String groupId, String topicFilter) {
